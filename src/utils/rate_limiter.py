...
class RateLimiter:
    ...
    def __init__(self, requests_per_minute: int = 10):
        ...
        self.stats = {"total_requests": 0, "rate_limited_requests": 0, "active_users": 0}
    ...
    def _clean_old_requests(self, user_id: str, current_time: float):
        ...
        if user_id in self.user_requests:
            ...
            self.user_requests[user_id] = [
                req_time for req_time in self.user_requests[user_id] if req_time > cutoff_time
            ]
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        self.user_requests = {
            user_id: requests for user_id, requests in self.user_requests.items() if requests
        }
