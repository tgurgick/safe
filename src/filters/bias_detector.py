...
class BiasDetector:
    ...
    def __init__(self, config: SafetyConfig):
        ...
        self.config = config
        self.stats = {"total_checks": 0, "bias_detected": 0, "false_positives": 0}
    ...
    def detect_bias(self, text: str) -> Dict[str, Any]:
        ...
        # Determine bias type
        bias_type = self._classify_bias_type(
            absolute_bias, stereotype_bias, discriminatory_bias, gender_bias, age_bias
        )
    ...
    def _classify_bias_type(
        self,
        absolute_bias: float,
        stereotype_bias: float,
        discriminatory_bias: float,
        gender_bias: float,
        age_bias: float,
    ) -> str:
