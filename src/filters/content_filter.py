...
class ContentFilter:
    ...
    def _init_keywords(self):
        ...
        self.violence_keywords = {
            'kill', 'murder', 'assassinate', 'bomb', 'explode', 'shoot', 'gun',
            'weapon', 'attack', 'fight', 'violence', 'blood', 'death', 'die',
            'suicide', 'terrorism', 'hack', 'cyberattack', 'destroy', 'harm'
        }
        
        # Hate speech keywords
        self.hate_speech_keywords = {
            'hate', 'racist', 'bigot', 'discriminate', 'slur', 'offensive',
            'insult', 'derogatory', 'prejudice', 'bias', 'stereotype'
        }
        
        # Bias-related keywords
        self.bias_keywords = {
            'all', 'everyone', 'nobody', 'always', 'never', 'typical',
            'usual', 'normal', 'abnormal', 'weird', 'strange'
        }
    ...
    def analyze_content(self, text: str) -> SafetyScore:
        ...
        reasoning = self._generate_reasoning(
            violence_score, hate_speech_score, bias_score, 
            privacy_score, factual_score, flagged_keywords
        )
    ...
    def _analyze_factual_accuracy(self, text: str) -> float:
        ...
        factual_indicators = [
            'fact', 'true', 'accurate', 'verified', 'confirmed',
            'false', 'fake', 'hoax', 'conspiracy', 'rumor'
        ]
    ...
    def _generate_reasoning(self, violence_score: float, hate_speech_score: float,
                           bias_score: float, privacy_score: float, factual_score: float,
                           flagged_keywords: List[str]) -> str:
    ...
    def _calculate_confidence(self, violence_score: float, hate_speech_score: float,
                             bias_score: float, privacy_score: float, factual_score: float) -> float:
